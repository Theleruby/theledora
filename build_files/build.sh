...
dnf5 install -y htop execstack libzip-tools putty firejail
...
wget https://stuff.theleruby.com/AppImage/Avidemux-x86_64_20260727.AppImage -O /usr/bin/avidemux.AppImage
